...
export class Direction {
    ...
    toString(): string {
        return format("%s",  DirectionEnum[this.value].charAt(0))
    }

    isNorth() {
      return this.value === DirectionEnum.NORTH;
    }
    isWest() {
      return this.value === DirectionEnum.WEST;
    }
    isEast() {
      return this.value === DirectionEnum.EAST;
    }
    isSouth() {
      return this.value === DirectionEnum.SOUTH;
    }
